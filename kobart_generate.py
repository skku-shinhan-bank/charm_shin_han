...
#                             type=str,
#                             default='train_chatData.csv',
#                             help='train file')

#         parser.add_argument('--test_file',
#                             type=str,
#                             default='test_chatData.csv',
#                             help='test file')
...
class KoBartGenerator:
    ...
    #     # parser = ChatDataModule.add_model_specific_args(parser)  #batch_size, lr, warmup_ratio, model_path
        ...
        trainer = pl.Trainer.from_argparse_args(config, logger=tb_logger)
    ...
    # if args.chat:
        ...
        for n in range(len(test_file)):
            answer=test_file[n][0]
            print("Comment > {}".format(model.chat(answer)))