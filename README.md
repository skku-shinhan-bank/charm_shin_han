...
keyword_rank = ke_analyze(train_data, ngram_threshold = 10, pmi_threshold = 1E-06) # change threshold values (Default: ngram_threshold = 5, pmi_threshold = 0.0001)
keyword_rank = ke_analyze(train_data, use_noun = True, use_prodicate = False) # Choose whether to register nouns or prodicates to keyword 
```